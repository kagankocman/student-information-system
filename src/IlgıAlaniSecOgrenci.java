...
public class IlgıAlaniSecOgrenci extends javax.swing.JFrame {
    ...
    public IlgıAlaniSecOgrenci(String kullaniciAd) {
        initComponents();
            ...
            try {
                ...
                if (!secilenIlgiAlanlari.isEmpty()) {
                    for (String ilgiAlani : secilenIlgiAlanlari) {
                        String updateSQL = "UPDATE ogrenci SET ilgialani = array_append(ilgialani, ?) WHERE kullaniciad = ?";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IlgıAlaniSecOgrenci(kullaniciAd).setVisible(true);
            }
        });
    }
